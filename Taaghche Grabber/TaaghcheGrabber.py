...
for page in range(number_of_pages):
    ...
    print(page)
    # Click next
    pyautogui.click(35, 540)
    # let the animation end, less value may cause taking bad photos
    sleep(0.4)
    # Stop When Mouse Triggered
    if pyautogui.position()[0] != 35:
        break

# Save to PDF
pages_list[0].save(r'C:\Users\Hessam\Desktop\HargezSazeshNakonid.pdf', save_all=True, append_images=pages_list)
